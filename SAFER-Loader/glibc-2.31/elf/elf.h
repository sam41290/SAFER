...
#define PT_SBI_ATT  0x80000000  /* Marks the location of SBI's Address translation table */
...
#define R_X86_64_SBIENC0 44 /* SBI's pointer encoding scheme 0 */
#define R_X86_64_ISBIENC0 45 /* SBI's pointer encoding scheme 0 */
