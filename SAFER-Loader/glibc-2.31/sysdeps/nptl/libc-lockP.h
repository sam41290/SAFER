...
# define __rtld_lock_lock_recursive(NAME) \
  ({ __typeof (GL(dl_rtld_lock_recursive)) _fn = (__typeof (GL(dl_rtld_lock_recursive)))gtf((unsigned long)(GL(dl_rtld_lock_recursive)));\
  _fn (&(NAME).mutex);})

# define __rtld_lock_unlock_recursive(NAME) \
  ({ __typeof (GL(dl_rtld_unlock_recursive)) _fn = (__typeof (GL(dl_rtld_lock_recursive)))gtf((unsigned long)(GL(dl_rtld_unlock_recursive)));\
  _fn (&(NAME).mutex);})
#else
# define __rtld_lock_lock_recursive(NAME) \
