...
namespace SBI {
   ...
   class AnalysisHandler {
    ...
    private:
      ...
      unordered_map<IMM,SBAFunction*> f_map_;
    ...
    private:
      ...
      unordered_map <IMM,RTL*> rtlMap_;

    public:
      AnalysisHandler(const vector<tuple<IMM,RTL*,vector<uint8_t>>>& offset_rtl_raw,
      ...
      unordered_map <IMM,RTL*> rtlMap() { return rtlMap_; }

      /* cfg */
      SBAFunction* func(IMM fptr);
