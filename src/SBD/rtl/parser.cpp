...
static RTL* process_rtl(const string& s) {
   ...
   /* (2) embedded side-effect --> wrapped in a sequence */
   {
      ...
      if (op.find("_dec") != string::npos) {
         if (elem.size() != 1) {
            ...
            src = new BinaryOP(BinaryOP::OP::PLUS,mode,elem[0]->clone(),new Const(-sz));
      }
   ...
   /* (3) expression */
   {
      ...
      /* binary */
         ...
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::PLUS, mode, elem[0], elem[1]))
      else if (op.compare("minus") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::MINUS, mode, elem[0], elem[1]))
      else if (op.compare("mult") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::MULT, mode, elem[0], elem[1]))
      else if (op.compare("div") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::DIV, mode, elem[0], elem[1]))
      else if (op.compare("udiv") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::UDIV, mode, elem[0], elem[1]))
      else if (op.compare("mod") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::MOD, mode, elem[0], elem[1]))
      else if (op.compare("umod") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::UMOD, mode, elem[0], elem[1]))
      else if (op.compare("and") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::AND, mode, elem[0], elem[1]))
      else if (op.compare("ior") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::IOR, mode, elem[0], elem[1]))
      else if (op.compare("xor") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::XOR, mode, elem[0], elem[1]))
      else if (op.compare("ashift") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::ASHIFT, mode, elem[0], elem[1]))
      else if (op.compare("ashiftrt") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::ASHIFTRT, mode, elem[0], elem[1]))
      else if (op.compare("lshiftrt") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::LSHIFTRT, mode, elem[0], elem[1]))
      else if (op.compare("rotate") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::ROTATE, mode, elem[0], elem[1]))
      else if (op.compare("rotatert") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::ROTATERT, mode, elem[0], elem[1]))
      else if (op.compare("compare") == 0)
         RETURN_RTL(2, new BinaryOP(BinaryOP::OP::COMPARE, mode, elem[0], elem[1]))
      /* ternary */
      /* compare */
