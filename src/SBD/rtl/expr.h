...
namespace SBI {
   ...
   class Expr: public RTL {
    ...
    public:
      ...
      vector<string> readsReg() override { vector<string> res; return res; }
      vector<string> writesReg() override { vector<string> res; return res; }
   };
   /* ------------------------------- Const --------------------------------- */
   ...
   class Mem: public Var {
    ...
    public:
      ...
      vector<string> readsReg() override { 
        //cout<<"Regs read - Mem"<<endl;
        return addr_->readsReg(); 
      }
   };
   ...
   class Reg: public Var {
    ...
    public:
      ...
      Expr* clone() override;
      vector<string> readsReg() override { 
         //cout<<"Regs read - Reg"<<endl;
         vector<string> res; 
	 res.push_back(X86_64::to_string(r_)); 
	 return res; 
      }
      vector<string> writesReg() override {
         vector<string> res; 
	 res.push_back(X86_64::to_string(r_)); 
	 return res; 
      }
   ...
   class SubReg: public Expr {
    ...
    public:
      ...
      Expr* clone() override;
      bool contains(RTL* subExpr) const override;
      vector<string> readsReg() override { return expr_->readsReg(); }
      vector<string> writesReg() override { return expr_->readsReg(); }
   };
   /* ------------------------------- IfElse -------------------------------- */
   class IfElse: public Expr {
    ...
    public:
      ...
      Expr* clone() override;
      bool contains(RTL* subExpr) const override;
      vector<string> readsReg() override;// { return cmp_->readsReg(); }
      vector<string> writesReg() override { vector<string> res; return res; }
   };
   /* ----------------------------- Conversion ------------------------------ */
