...
static pair<int64_t,Expr::EXPR_MODE> extract_mode(const string& s) {
   ...
   for (int i = 0; i < 38; ++i)
      if (mode_str.compare(Expr::MODE_STR[i]) == 0)
         return make_pair((int64_t)(Expr::MODE_SZ[i]), (Expr::EXPR_MODE)i);
...
static RTL* process_rtl(const string& s) {
   ...
   /* (1) statements */
   {
      if (op.compare("parallel") == 0) {
         ...
         return new Assign(elem[0], elem[1]);
      else if (op.compare("call") == 0)
         return new Call((Mem*)(elem[0]));
      else if (op.compare("clobber") == 0)
         return new Clobber(elem[0]);
   ...
   /* (3) expression */
   {
      ...
      if (op.compare("reg") == 0) {
         ...
         if (ARCH::from_string(s) == ARCH::REG::UNKNOWN) {
            delete_elem(elem);
            return nullptr;
         }
         ...
         return new Mem(mode, elem[0]);
      else if (op.compare("subreg") == 0)
         return new SubReg(mode, elem[0], elem[1]);
      /* const */
         ...
         return new Const(Const::CONST_TYPE::DOUBLE, elem[0]);
      /* if_then_else */
      else if (op.compare("if_then_else") == 0)
         return new IfElse(mode, (Compare*)(elem[0]), elem[1], elem[2]);
      /* unary */
      else if (op.compare("neg") == 0)
         return new Unary(Unary::OP::NEG, mode, elem[0]);
      else if (op.compare("not") == 0)
         return new Unary(Unary::OP::NOT, mode, elem[0]);
      else if (op.compare("abs") == 0)
         return new Unary(Unary::OP::ABS, mode, elem[0]);
      else if (op.compare("sqrt") == 0)
         return new Unary(Unary::OP::SQRT, mode, elem[0]);
      else if (op.compare("clz") == 0)
         return new Unary(Unary::OP::CLZ, mode, elem[0]);
      else if (op.compare("ctz") == 0)
         return new Unary(Unary::OP::CTZ, mode, elem[0]);
      else if (op.compare("bswap") == 0)
         return new Unary(Unary::OP::BSWAP, mode, elem[0]);
      /* binary */
      else if (op.compare("plus") == 0)
         return new Binary(Binary::OP::PLUS, mode, elem[0], elem[1]);
      else if (op.compare("minus") == 0)
         return new Binary(Binary::OP::MINUS, mode, elem[0], elem[1]);
      else if (op.compare("mult") == 0)
         return new Binary(Binary::OP::MULT, mode, elem[0], elem[1]);
      else if (op.compare("div") == 0)
         return new Binary(Binary::OP::DIV, mode, elem[0], elem[1]);
      else if (op.compare("udiv") == 0)
         return new Binary(Binary::OP::UDIV, mode, elem[0], elem[1]);
      else if (op.compare("mod") == 0)
         return new Binary(Binary::OP::MOD, mode, elem[0], elem[1]);
      else if (op.compare("umod") == 0)
         return new Binary(Binary::OP::UMOD, mode, elem[0], elem[1]);
      else if (op.compare("and") == 0)
         return new Binary(Binary::OP::AND, mode, elem[0], elem[1]);
      else if (op.compare("ior") == 0)
         return new Binary(Binary::OP::IOR, mode, elem[0], elem[1]);
      else if (op.compare("xor") == 0)
         return new Binary(Binary::OP::XOR, mode, elem[0], elem[1]);
      else if (op.compare("ashift") == 0)
         return new Binary(Binary::OP::ASHIFT, mode, elem[0], elem[1]);
      else if (op.compare("ashiftrt") == 0)
         return new Binary(Binary::OP::ASHIFTRT, mode, elem[0], elem[1]);
      else if (op.compare("lshiftrt") == 0)
         return new Binary(Binary::OP::LSHIFTRT, mode, elem[0], elem[1]);
      else if (op.compare("rotate") == 0)
         return new Binary(Binary::OP::ROTATE, mode, elem[0], elem[1]);
      else if (op.compare("rotatert") == 0)
         return new Binary(Binary::OP::ROTATERT, mode, elem[0], elem[1]);
      else if (op.compare("compare") == 0)
         return new Binary(Binary::OP::COMPARE, mode, elem[0], elem[1]);
      /* ternary */
      /* compare */
      else if (op.compare("eq") == 0)
         return new Compare(Compare::OP::EQ, mode, elem[0]);
      else if (op.compare("ne") == 0)
         return new Compare(Compare::OP::NE, mode, elem[0]);
      else if (op.compare("gt") == 0)
         return new Compare(Compare::OP::GT, mode, elem[0]);
      else if (op.compare("gtu") == 0)
         return new Compare(Compare::OP::GTU, mode, elem[0]);
      else if (op.compare("ge") == 0)
         return new Compare(Compare::OP::GE, mode, elem[0]);
      else if (op.compare("geu") == 0)
         return new Compare(Compare::OP::GEU, mode, elem[0]);
      else if (op.compare("lt") == 0)
         return new Compare(Compare::OP::LT, mode, elem[0]);
      else if (op.compare("ltu") == 0)
         return new Compare(Compare::OP::LTU, mode, elem[0]);
      else if (op.compare("le") == 0)
         return new Compare(Compare::OP::LE, mode, elem[0]);
      else if (op.compare("leu") == 0)
         return new Compare(Compare::OP::LEU, mode, elem[0]);
      else if (op.compare("unle") == 0)
         return new Compare(Compare::OP::UNLE, mode, elem[0]);
      else if (op.compare("unlt") == 0)
         return new Compare(Compare::OP::UNLT, mode, elem[0]);
      else if (op.compare("uneq") == 0)
         return new Compare(Compare::OP::UNEQ, mode, elem[0]);
      else if (op.compare("ltgt") == 0)
         return new Compare(Compare::OP::LTGT, mode, elem[0]);
      else if (op.compare("ordered") == 0)
         return new Compare(Compare::OP::ORDERED, mode, elem[0]);
      else if (op.compare("unordered") == 0)
         return new Compare(Compare::OP::UNORDERED, mode, elem[0]);
      /* conversion */
      else if (op.compare("zero_extract") == 0)
         return new Conversion(Conversion::OP::ZERO_EXTRACT, mode,
                               elem[0], elem[1], elem[2]);
      else if (op.compare("sign_extract") == 0)
         return new Conversion(Conversion::OP::SIGN_EXTRACT, mode,
                               elem[0], elem[1], elem[2]);
      else if (op.compare("truncate") == 0)
         return new Conversion(Conversion::OP::TRUNCATE, mode, elem[0]);
      else if (op.compare("sstruncate") == 0)
         return new Conversion(Conversion::OP::STRUNCATE, mode, elem[0]);
      else if (op.compare("ustruncate") == 0)
         return new Conversion(Conversion::OP::UTRUNCATE, mode, elem[0]);
      else if (op.compare("float") == 0)
         return new Conversion(Conversion::OP::SFLOAT, mode, elem[0]);
      else if (op.compare("unsigned_float") == 0)
         return new Conversion(Conversion::OP::UFLOAT, mode, elem[0]);
      else if (op.compare("fix") == 0)
         return new Conversion(Conversion::OP::FIX, mode, elem[0]);
      else if (op.compare("unsigned_fix") == 0)
         return new Conversion(Conversion::OP::UFIX, mode, elem[0]);
      else if (op.compare("zero_extend") == 0)
         return new Conversion(Conversion::OP::ZERO_EXTEND, mode, elem[0]);
      else if (op.compare("sign_extend") == 0)
         return new Conversion(Conversion::OP::SIGN_EXTEND, mode, elem[0]);
      else if (op.compare("float_extend") == 0)
         return new Conversion(Conversion::OP::FLOAT_EXTEND, mode, elem[0]);
      else if (op.compare("strict_low_part") == 0)
         return new Conversion(Conversion::OP::STRICT_LOW_PART, mode, elem[0]);
   }
