...
.43490: movq %rdi, %r12 
.43493: pushq %rbx 
.43494: subq $0x368, %rsp 
.43501: movl %edx, -0x384(%rbp) 
.43507: movq .148400(%rip), %rcx 
.43514: movq .148416(%rip), %rdi 
.43521: movq %fs:0x28, %rax 
.43530: movq %rax, -0x38(%rbp) 
.43534: xorl %eax, %eax 
.43536: cmpq .148408(%rip), %rcx 
.43543: jne .43621 
.43545: movl $0x190, %edx 
.43550: movq %rdx, %rax 
.43553: mulq %rcx 
.43556: seto %dl 
.43559: movzbl %dl, %edx 
...
.43571: testq %rdx, %rdx 
.43574: jne .47279 
.43580: leaq (%rcx, %rcx, 4), %rax 
.43584: leaq (%rax, %rax, 4), %rsi 
.43588: shlq $4, %rsi 
.43592: callq .88352 
.43597: movq .148400(%rip), %rcx 
.43604: shlq $1, .148408(%rip) 
.43611: movq %rax, .148416(%rip) 
.43618: movq %rax, %rdi 
.43621: leaq (%rcx, %rcx, 4), %rax 
.43625: leaq (%rax, %rax, 4), %rax 
.43629: leaq (%rdi, %rax, 8), %rbx 
.43633: xorl %eax, %eax 
.43635: leaq 8(%rbx), %rdi 
.43639: movq %rbx, %rcx 
.43642: movq $0, 0xc0(%rbx) 
.43653: andq $0xfffffffffffffff8, %rdi 
.43657: movq $0, (%rbx) 
.43664: subq %rdi, %rcx 
.43667: addl $0xc8, %ecx 
.43673: shrl $3, %ecx 
.43676: rep stosq %rax, (%rdi) 
.43679: movq $0, 0x20(%rbx) 
.43687: movl %r13d, 0xa8(%rbx) 
.43694: cmpb $0, .148393(%rip) 
.43701: movl $0xffffffff, 0xc4(%rbx) 
.43711: jne .43726 
.43713: cmpb $0, .148392(%rip) 
.43720: jne .45792 
.43726: cmpb $0, -0x384(%rbp) 
.43733: movzbl .148241(%rip), %r8d 
.43741: je .44064 
.43747: movzbl (%r12), %edx 
.43752: movq %r12, %r14 
.43755: cmpb $0x2f, %dl 
.43758: je .43773 
.43760: movzbl (%r15), %esi 
.43764: testb %sil, %sil 
.43767: jne .44337 
.43773: testb %r8b, %r8b 
.43776: jne .45521 
...
.45795: callq .28704 
.45800: movzbl %al, %edx 
.45803: movl %edx, 0xc4(%rbx) 
.45809: testb %al, %al 
.45811: je .43726 
.45817: movb $1, .148393(%rip) 
.45824: jmp .43726 
