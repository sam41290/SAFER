...
.35445: pushq %rbx 
.35446: subq $0x18, %rsp 
.35450: movzbl .148242(%rip), %eax 
.35457: testb %sil, %sil 
.35460: je .35600 
.35466: movq 8(%rdi), %r13 
.35470: testb %al, %al 
.35472: jne .35552 
.35474: subq $8, %rsp 
...
.35603: testb %al, %al 
.35605: je .35474 
.35611: cmpb $0, .148368(%rip) 
.35618: movzbl 0xb9(%rdi), %edx 
.35625: jne .36040 
.35631: movl 0x30(%r12), %esi 
