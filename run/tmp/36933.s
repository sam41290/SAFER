...
.36952: pushq %rbp 
.36953: pushq %rbx 
.36954: subq $0x1000, %rsp 
.36961: orq $0, (%rsp) 
.36966: subq $0x328, %rsp 
.36973: movq %fs:0x28, %rax 
.36982: movq %rax, 0x1318(%rsp) 
.36990: xorl %eax, %eax 
.36992: cmpb $0, 0xb8(%rdi) 
.36999: movq %rdi, %r12 
.37002: je .38032 
.37008: leaq 0xb4(%rsp), %rsi 
.37016: leaq 0x18(%rdi), %rdi 
.37020: callq .58624 
.37025: cmpb $0, .148324(%rip) 
.37032: jne .38110 
.37038: movb $0, 0xbe(%rsp) 
.37046: movl .148276(%rip), %eax 
.37052: cmpl $1, %eax 
.37055: je .38160 
.37061: cmpl $2, %eax 
.37064: jne .37832 
.37070: movq 0x68(%r12), %rax 
.37075: movq 0x60(%r12), %rdx 
.37080: movq %rax, 0x28(%rsp) 
.37085: movq %rdx, 0x20(%rsp) 
...
.38023: jmp .37531 
.38032: movl 0xa8(%rdi), %eax 
.38038: leaq .100176(%rip), %rdx 
.38045: movl $0x3f3f, %r10d 
.38051: cmpb $0, .148324(%rip) 
.38058: movw %r10w, 0xbd(%rsp) 
.38067: movzbl (%rdx, %rax), %eax 
.38071: movb $0, 0xbf(%rsp) 
.38079: movb %al, 0xb4(%rsp) 
.38086: movabsq $0x3f3f3f3f3f3f3f3f, %rax 
.38096: movq %rax, 0xb5(%rsp) 
.38104: je .37038 
.38110: movl 0xbc(%r12), %eax 
.38118: cmpl $1, %eax 
.38121: je .38976 
.38127: cmpl $2, %eax 
.38130: jne .37046 
.38136: movl .148276(%rip), %eax 
.38142: movb $0x2b, 0xbe(%rsp) 
.38150: cmpl $1, %eax 
.38153: jne .37061 
.38159: nop 
.38160: movq 0x88(%r12), %rax 
.38168: movq 0x80(%r12), %rdx 
.38176: movq %rax, 0x28(%rsp) 
.38181: movq %rdx, 0x20(%rsp) 
.38186: jmp .37090 
.38192: jmp .19872 
.38200: cmpq $0, 8(%r12) 
.38206: je .37784 
