...
.19972: subq $0x48, %rsp 
.19976: movq (%rsi), %rdi 
.19979: movq %fs:0x28, %rax 
.19988: movq %rax, 0x38(%rsp) 
.19993: xorl %eax, %eax 
.19995: callq .78544 
.20000: leaq .104446(%rip), %rsi 
.20007: movl $6, %edi 
.20012: callq .19456 
.20017: leaq .104777(%rip), %rsi 
.20024: leaq .104751(%rip), %rdi 
.20031: callq .18576 
.20036: leaq .104751(%rip), %rdi 
.20043: callq .18512 
.20048: leaq .57312(%rip), %rdi 
.20055: movl $2, .143864(%rip) 
.20065: callq .95584 
.20070: movb $1, .148152(%rip) 
.20077: movabsq $0x8000000000000000, %rax 
.20087: movq %rax, .148336(%rip) 
.20094: movl .143840(%rip), %eax 
.20100: movl $0, .147984(%rip) 
.20110: movq $0, .148352(%rip) 
.20121: movq $-1, .148344(%rip) 
.20132: movb $0, .148184(%rip) 
.20139: cmpl $2, %eax 
.20142: je .23778 
.20148: cmpl $3, %eax 
.20151: jne .20616 
...
.24264: movl $3, %esi 
.24269: xorl %edi, %edi 
.24271: movl $2, .148280(%rip) 
.24281: callq .84160 
.24286: movb $1, .148184(%rip) 
.24293: jmp .20179 
