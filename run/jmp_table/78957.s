...
.80007: jmp .79832 
.80012: movb $1, 8(%rsp) 
.80017: xorl %r13d, %r13d 
.80020: movb $0, 0x84(%rsp) 
.80028: movq $0, 0x58(%rsp) 
.80037: movb $1, 0x63(%rsp) 
.80041: addl %eax, %esi 
.80042: movb $0, 0x10(%rsp) 
.80043: andb $0x10, %al 
.80046: addb %cl, -0x73(%rax) 
.80047: leaq .118747(%rip), %rax 
.80049: addl $0x9725, %eax 
...
.80159: addb %cl, -0x77(%rax) 
.80160: movq %rax, 0x50(%rsp) 
.80162: andb $0x50, %al 
.80165: jmp .79344 
.80170: testl %ebx, %ebx 
.80172: jne .80012 
.80178: movb $1, 0x10(%rsp) 
.80183: testq %r14, %r14 
.80186: jne .83553 
...
.80325: jmp .79344 
.80330: movb $1, 8(%rsp) 
.80335: xorl %r13d, %r13d 
.80338: xorl %r12d, %r12d 
.80341: movb $0, 0x84(%rsp) 
.80349: movq $0, 0x58(%rsp) 
.80358: movb $0, 0x63(%rsp) 
.80363: movb $1, 0x10(%rsp) 
.80368: movq $0, 0x20(%rsp) 
.80377: movq $0, 0x50(%rsp) 
.80386: jmp .79344 
.80391: movb $1, 8(%rsp) 
.80396: xorl %r13d, %r13d 
.80399: xorl %r12d, %r12d 
.80402: movb $0, 0x84(%rsp) 
.80410: movq $0, 0x58(%rsp) 
...
.80447: jmp .79344 
.80452: movb $1, 8(%rsp) 
.80457: xorl %r13d, %r13d 
.80460: movb $0, 0x84(%rsp) 
